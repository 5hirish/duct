...
/**
 * Sticky progress strip rendered above the chat transcript. Mirrors
 * AuditTodos. Hides when the agent hasn't emitted any TodoWrite yet.
 */
export default function ContentTodos({ todos }) {
