...
|--------|----------|----------|
| [`engineering/`](engineering/) | Engineers | Active implementation plans and ops runbooks ([Claude Code on the web](engineering/claude-code-on-the-web.md), [User storage: Postgres + SQLModel + Alembic](engineering/user-storage-railway-postgres-sqlmodel-alembic.md), [Google Ads API tool design](engineering/google-ads-api-tool-design-document.md), [Agent memory research + design](engineering/agent-memory-research.html), [Desktop-adaptive UI review](engineering/desktop-adaptive-ui-review.html)) |
